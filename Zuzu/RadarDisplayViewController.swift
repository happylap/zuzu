...
extension RadarDisplayViewController{
    ...
    func alertUnfinishTransactionsStatus(success: Int, fail: Int){
        ...
        if fail <= 0{
            RadarDisplayViewController.getAlertView()?.showInfo("服務建立成功", subTitle: "所有服務已經建立完成", closeButtonTitle: "知道了", colorStyle: 0x1CD4C6, colorTextButton: 0xFFFFFF).setDismissBlock(){
